function generateCertificate() {
  ...
  // HTML डिजाइन सेट करें
  const certHTML = `
    <div style="width:800px; height:600px; padding:40px; border:10px solid #2c3e50; text-align:center; font-family:sans-serif;">
      <h1 style="color:#2c3e50;">Certificate of Participation</h1>
      <p style="font-size:20px;">This is to certify that</p>
      <h2 style="color:#16a085;">${student.name}</h2>
